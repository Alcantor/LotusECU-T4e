...
print(f"cmplwi %r2,30       {print_hex(PPC32.ppc_cmpli(2, 30))}")
print(f"li     %r3,1        {print_hex(PPC32.ppc_li(3, 1))}")
print(f"lis    %r3,1        {print_hex(PPC32.ppc_lis(3, 1))}")
print(f"b      -0x12B       {print_hex(PPC32.ppc_b(-0x12B))}")
print(f"ba     0x3DC400     {print_hex(PPC32.ppc_ba(0x3DC400))}")
print(f"blr                 {print_hex(PPC32.ppc_blr())}")
print(f"mfspr  %r30,630     {print_hex(PPC32.ppc_mfspr(30, 630))}")
print(f"mtspr  27,%r31      {print_hex(PPC32.ppc_mtspr(31, 27))}")
print(f"lwz    %r31,0(%r30) {print_hex(PPC32.ppc_lwz(31, 30, 0))}")
print(f"stw    %r31,0(%r30) {print_hex(PPC32.ppc_stw(31, 30, 0))}")
print(f"and    %r0,%r0,%r0  {print_hex(PPC32.ppc_and(0, 0, 0))}")
print(f"rfi                 {print_hex(PPC32.ppc_rfi())}")
