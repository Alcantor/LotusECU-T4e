...
class MapTable(tk.Canvas):
	...
	def __init__(self, parent, xname, read_xdata, yname, read_ydata, name, read_data, write_cell=lambda x,y,value:None, xfmt="{:d}", yfmt="{:d}", datafmt="{:d}"):
		...
		self.yaxis = [self.create_text(self.CELLH, self.CELLH*(y+1)+4, anchor=tk.N, justify=tk.CENTER, text=yfmt.format(self.ydata[y]), font=('Helvetica 8')) for y in range(0,self.ysize)]
