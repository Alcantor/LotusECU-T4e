...
public class OBD2CodeConfiguration extends GhidraScript {
	...
	public void run() throws Exception {
		...
		try {
			// Descriptions live at ../../documentation/OBD/Lotus OBD Codes/OBD2-DTCs.csv,
			// generated by OBD2-DTCs.linq ordered by ECU set priority (EMS first,
			// SYSTEM_UNKNOWN last): the first text per code wins.
			...
			try (BufferedReader br = new BufferedReader(new FileReader(csvFile))) {
				...
				while ((line = br.readLine()) != null) {
					...
					dtcDescriptions.putIfAbsent(code, desc);
				}
			}
